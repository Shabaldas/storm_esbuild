describe '/dredd/orders', type: :request do
  ...
  describe 'GET /dredd/orders' do
    ...
    it 'display all orders' do
      ...
      expect(response.body).to include(dredd_order_path(order_first))
      expect(response.body).to include(dredd_order_path(order_second))
      expect(response.body).to include(dredd_order_path(order_third))
    end
  end
end
